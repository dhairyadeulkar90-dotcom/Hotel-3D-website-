...
export default function App() {
  ...
  // Intercept all internal anchor link clicks to do a majestic slow scroll
  useEffect(() => {
    const handleAnchorClick = (e: MouseEvent) => {
      ...
      if (href && href.startsWith('#') && href.length > 1) {
        ...
        if (targetElement && scrollContainer) {
          ...
          // Slow scroll over 2200ms (2.2s) with beautiful Cubic ease-out
          const duration = 2200;
          ...
          const step = (timestamp: number) => {
            ...
            // Quartic ease-out: beautiful deceleration
  ...
  const handleSelectRoom = (roomId: string) => {
    ...
    if (element && scrollContainer) {
      ...
      const conRect = scrollContainer.getBoundingClientRect();
      const targetTop = scrollContainer.scrollTop + (elRect.top - conRect.top);
      
      // Majestic, custom slow scroll to rooms-section
      const duration = 1800;
      const start = scrollContainer.scrollTop;
      const change = targetTop - start;
      let startTime: number | null = null;
    ...
    <div className="min-h-screen bg-[#07080a] text-white flex flex-col relative font-sans overflow-x-hidden" id="applet-viewport">
      ...
      <div className="flex-grow flex flex-col relative" id="resort-master-frame">
        ...
        <div className="flex-grow flex relative" id="body-chassis">
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 relative bg-[#06070a]" id="main-hotel-scroll-area">
            ...
            >
              ...
              >
                ...
                >
                  {activeCopy ? activeCopy.headline.replace(/Infinity/g, '') : "A Sanctuary Built Around the "}
                ...
                >
                  {activeCopy ? activeCopy.subHeadline : "Framing water, land and sky."}
                </motion.p>
